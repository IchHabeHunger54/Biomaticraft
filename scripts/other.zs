...
stonecutter([<item:minecraft:basalt>, <item:minecraft:polished_basalt>, <item:quark:vanilla_basalt_bricks>, <item:quark:smooth_basalt>]);
stonecutter([<item:quark:deepslate>, <item:quark:cobbled_deepslate>, <item:quark:polished_deepslate>, <item:quark:deepslate_bricks>, <item:quark:deepslate_tiles>, <item:quark:chiseled_deepslate>, <item:quark:cracked_deepslate_bricks>, <item:quark:cracked_deepslate_tiles>]);
...
<item:cyclic:chorus_flight>.food = food;
<item:cyclic:chorus_spectral>.food = food;
...
food = new MCFood(2, 1.5);
<item:minecraft:glistering_melon_slice>.food = food;
