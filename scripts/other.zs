...
<recipetype:thermal:bottler>.removeAll();
<recipetype:thermal:brewer>.removeAll();
<recipetype:thermal:centrifuge>.removeAll();
<recipetype:thermal:chiller>.removeAll();
<recipetype:thermal:compression_fuel>.removeAll();
<recipetype:thermal:crucible>.removeAll();
<recipetype:thermal:furnace>.removeAll();
<recipetype:thermal:insolator>.removeAll();
<recipetype:thermal:insolator_catalyst>.removeAll();
<recipetype:thermal:lapidary_fuel>.removeAll();
<recipetype:thermal:magmatic_fuel>.removeAll();
<recipetype:thermal:numismatic_fuel>.removeAll();
<recipetype:thermal:potion_diffuser_boost>.removeAll();
<recipetype:thermal:press>.removeAll();
<recipetype:thermal:pulverizer>.removeAll();
<recipetype:thermal:pulverizer_catalyst>.removeAll();
<recipetype:thermal:refinery>.removeAll();
<recipetype:thermal:rock_gen>.removeAll();
<recipetype:thermal:sawmill>.removeAll();
<recipetype:thermal:smelter>.removeAll();
<recipetype:thermal:smelter_catalyst>.removeAll();
<recipetype:thermal:stirling_fuel>.removeAll();
...
smithing.addRecipe("mattock_nether", <item:cyclic:mattock_nether>, <item:cyclic:mattock>, <item:minecraft:netherite_ingot>);
...
blast("oil_sand", <item:thermal:oil_sand>, <item:thermal:tar> * 3);
blast("oil_red_sand", <item:thermal:oil_red_sand>, <item:thermal:tar> * 3);
...
<item:inspirations:ancient_bookshelf>.burnTime = 0;
<item:inspirations:bookshelf>.burnTime = 0;
<item:inspirations:rainbow_bookshelf>.burnTime = 0;
<item:inspirations:tomes_bookshelf>.burnTime = 0;
...
<item:thermal:bitumen>.burnTime = 1600;
<item:thermal:bitumen_block>.burnTime = 14400;
<item:thermal:coal_coke>.burnTime = 3200;
<item:thermal:coal_coke_block>.burnTime = 28800;
<item:thermal:oil_red_sand>.burnTime = 2400;
<item:thermal:oil_sand>.burnTime = 2400;
<item:thermal:rosin>.burnTime = 0;
<item:thermal:rosin_block>.burnTime = 0;
<item:thermal:sawdust>.burnTime = 200;
<item:thermal:sawdust_block>.burnTime = 1800;
<item:thermal:sulfur>.burnTime = 0;
<item:thermal:sulfur_block>.burnTime = 0;
<item:thermal:sulfur_dust>.burnTime = 0;
<item:thermal:tar>.burnTime = 800;
<item:thermal:tar_block>.burnTime = 7200;
...
for item in game.items {
	item.removeTooltip("You shouldn't see this");
}
<item:patchouli:guide_book>.removeTooltip("Edition");
...
<item:botania:black_lotus>.removeTooltip("Emits");
<item:botania:blacker_lotus>.removeTooltip("Emits");
<item:botania:hydroangeas_motif>.removeTooltip("Decorative");
<item:botania:mana_bottle>.removeTooltip("Very");
<item:botania:pinkinator>.removeTooltip("Wither");
<item:botanypots:botany_pot>.removeTooltip("pot");
<item:botanypots:hopper_botany_pot>.removeTooltip("pot");
<item:ceramics:porcelain_channel>.removeTooltip("Transfers");
<item:ceramics:porcelain_faucet>.removeTooltip("Pours");
<item:ceramics:porcelain_gauge>.removeTooltip("Place");
<item:ceramics:terracotta_channel>.removeTooltip("Transfers");
<item:ceramics:terracotta_faucet>.removeTooltip("Pours");
<item:ceramics:terracotta_gauge>.removeTooltip("Place");
<item:chiselsandbits:bit_bag>.removeTooltip("Auto");
<item:chiselsandbits:bit_storage>.removeTooltip("Fill");
<item:chiselsandbits:bitsaw_diamond>.removeTooltip("axis");
<item:chiselsandbits:bitsaw_diamond>.removeTooltip("blocks");
<item:chiselsandbits:bitsaw_gold>.removeTooltip("axis");
<item:chiselsandbits:bitsaw_gold>.removeTooltip("blocks");
<item:chiselsandbits:bitsaw_iron>.removeTooltip("axis");
<item:chiselsandbits:bitsaw_iron>.removeTooltip("blocks");
<item:chiselsandbits:bitsaw_netherite>.removeTooltip("axis");
<item:chiselsandbits:bitsaw_netherite>.removeTooltip("blocks");
<item:chiselsandbits:bitsaw_stone>.removeTooltip("axis");
<item:chiselsandbits:bitsaw_stone>.removeTooltip("blocks");
<item:chiselsandbits:chisel_diamond>.removeTooltip("Attack");
<item:chiselsandbits:chisel_diamond>.removeTooltip("menu");
<item:chiselsandbits:chisel_gold>.removeTooltip("Attack");
<item:chiselsandbits:chisel_gold>.removeTooltip("menu");
<item:chiselsandbits:chisel_iron>.removeTooltip("Attack");
<item:chiselsandbits:chisel_iron>.removeTooltip("menu");
<item:chiselsandbits:chisel_netherite>.removeTooltip("Attack");
<item:chiselsandbits:chisel_netherite>.removeTooltip("menu");
<item:chiselsandbits:chisel_printer>.removeTooltip("Allows");
<item:chiselsandbits:chisel_stone>.removeTooltip("Attack");
<item:chiselsandbits:chisel_stone>.removeTooltip("menu");
<item:chiselsandbits:magnifying_glass>.removeTooltip("over");
<item:chiselsandbits:mirrorprint>.removeTooltip("Right Button");
<item:chiselsandbits:mirrorprint>.removeTooltip("design");
<item:chiselsandbits:negativeprint>.removeTooltip("Mouse");
<item:chiselsandbits:negativeprint>.removeTooltip("Right Button");
<item:chiselsandbits:positiveprint>.removeTooltip("Mouse");
<item:chiselsandbits:positiveprint>.removeTooltip("Right Button");
<item:chiselsandbits:positiveprint>.removeTooltip("menu");
<item:chiselsandbits:tape_measure>.removeTooltip("Left Alt");
<item:chiselsandbits:tape_measure>.removeTooltip("Right Button");
<item:chiselsandbits:wrench_wood>.removeTooltip("Right Button");
<item:cookingforblockheads:cabinet>.removeTooltip("Can");
<item:cookingforblockheads:cabinet>.removeTooltip("Dyeable");
<item:cookingforblockheads:cabinet>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:cooking_table>.removeTooltip("Dyeable");
<item:cookingforblockheads:cooking_table>.removeTooltip("Enables");
<item:cookingforblockheads:cooking_table>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:corner>.removeTooltip("Connect");
<item:cookingforblockheads:corner>.removeTooltip("Dyeable");
<item:cookingforblockheads:corner>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:counter>.removeTooltip("Dyeable");
<item:cookingforblockheads:counter>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:counter>.removeTooltip("Stores");
<item:cookingforblockheads:cow_jar>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:cow_jar>.removeTooltip("Provides");
<item:cookingforblockheads:crafting_book>.removeTooltip("Can");
<item:cookingforblockheads:crafting_book>.removeTooltip("Crafting Book");
<item:cookingforblockheads:fridge>.removeTooltip("Dyeable");
<item:cookingforblockheads:fridge>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:fridge>.removeTooltip("Stores");
<item:cookingforblockheads:fruit_basket>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:fruit_basket>.removeTooltip("Stores");
<item:cookingforblockheads:hanging_corner>.removeTooltip("Connect");
<item:cookingforblockheads:hanging_corner>.removeTooltip("Dyeable");
<item:cookingforblockheads:hanging_corner>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:heating_unit>.removeTooltip("Allows");
<item:cookingforblockheads:heating_unit>.removeTooltip("Oven");
<item:cookingforblockheads:ice_unit>.removeTooltip("Fridge");
<item:cookingforblockheads:ice_unit>.removeTooltip("Provides");
<item:cookingforblockheads:milk_jar>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:milk_jar>.removeTooltip("Provides");
<item:cookingforblockheads:no_filter_edition>.removeTooltip("NoFilter Edition");
<item:cookingforblockheads:no_filter_edition>.removeTooltip("Shows");
<item:cookingforblockheads:oven>.removeTooltip("Enables");
<item:cookingforblockheads:oven>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:preservation_chamber>.removeTooltip("Fridge");
<item:cookingforblockheads:preservation_chamber>.removeTooltip("Prevents");
<item:cookingforblockheads:recipe_book>.removeTooltip("Recipe Book");
<item:cookingforblockheads:recipe_book>.removeTooltip("Shows");
<item:cookingforblockheads:recipe_book>.removeTooltip("things");
<item:cookingforblockheads:sink>.removeTooltip("Dyeable");
<item:cookingforblockheads:sink>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:sink>.removeTooltip("Provides");
<item:cookingforblockheads:spice_rack>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:spice_rack>.removeTooltip("Stores");
<item:cookingforblockheads:toaster>.removeTooltip("Magically");
<item:cookingforblockheads:toaster>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:tool_rack>.removeTooltip("Multiblock Kitchen");
<item:cookingforblockheads:tool_rack>.removeTooltip("Provides");
...
<item:mekanism:advanced_bin>.removeTooltip(" for a description.");
<item:mekanism:advanced_bounding_block>.removeTooltip(" for a description.");
<item:mekanism:advanced_chemical_tank>.removeTooltip(" for a description.");
<item:mekanism:advanced_combining_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_compressing_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_crushing_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_energy_cube>.removeTooltip(" for a description.");
<item:mekanism:advanced_enriching_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_fluid_tank>.removeTooltip(" for a description.");
<item:mekanism:advanced_induction_cell>.removeTooltip(" for a description.");
<item:mekanism:advanced_induction_provider>.removeTooltip(" for a description.");
<item:mekanism:advanced_infusing_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_injecting_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_logistical_transporter>.removeTooltip(" for a description.");
<item:mekanism:advanced_mechanical_pipe>.removeTooltip(" for a description.");
<item:mekanism:advanced_pressurized_tube>.removeTooltip(" for a description.");
<item:mekanism:advanced_purifying_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_sawing_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_smelting_factory>.removeTooltip(" for a description.");
<item:mekanism:advanced_thermodynamic_conductor>.removeTooltip(" for a description.");
<item:mekanism:advanced_universal_cable>.removeTooltip(" for a description.");
<item:mekanism:antiprotonic_nucleosynthesizer>.removeTooltip(" for a description.");
<item:mekanism:antiprotonic_nucleosynthesizer>.removeTooltip(" for a description.");
<item:mekanism:basic_bin>.removeTooltip(" for a description.");
<item:mekanism:basic_chemical_tank>.removeTooltip(" for a description.");
<item:mekanism:basic_combining_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_compressing_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_crushing_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_energy_cube>.removeTooltip(" for a description.");
<item:mekanism:basic_enriching_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_fluid_tank>.removeTooltip(" for a description.");
<item:mekanism:basic_induction_cell>.removeTooltip(" for a description.");
<item:mekanism:basic_induction_provider>.removeTooltip(" for a description.");
<item:mekanism:basic_infusing_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_injecting_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_logistical_transporter>.removeTooltip(" for a description.");
<item:mekanism:basic_mechanical_pipe>.removeTooltip(" for a description.");
<item:mekanism:basic_pressurized_tube>.removeTooltip(" for a description.");
<item:mekanism:basic_purifying_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_sawing_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_smelting_factory>.removeTooltip(" for a description.");
<item:mekanism:basic_thermodynamic_conductor>.removeTooltip(" for a description.");
<item:mekanism:basic_universal_cable>.removeTooltip(" for a description.");
<item:mekanism:boiler_casing>.removeTooltip(" for a description.");
<item:mekanism:boiler_valve>.removeTooltip(" for a description.");
<item:mekanism:chargepad>.removeTooltip(" for a description.");
<item:mekanism:chemical_crystallizer>.removeTooltip(" for a description.");
<item:mekanism:chemical_dissolution_chamber>.removeTooltip(" for a description.");
<item:mekanism:chemical_infuser>.removeTooltip(" for a description.");
<item:mekanism:chemical_injection_chamber>.removeTooltip(" for a description.");
<item:mekanism:chemical_oxidizer>.removeTooltip(" for a description.");
<item:mekanism:chemical_washer>.removeTooltip(" for a description.");
<item:mekanism:combiner>.removeTooltip(" for a description.");
<item:mekanism:copper_ore>.removeTooltip(" for a description.");
<item:mekanism:crusher>.removeTooltip(" for a description.");
<item:mekanism:dictionary>.removeTooltip(" for a description.");
<item:mekanism:digital_miner>.removeTooltip(" for a description.");
<item:mekanism:diversion_transporter>.removeTooltip(" for a description.");
<item:mekanism:dynamic_tank>.removeTooltip(" for a description.");
<item:mekanism:dynamic_valve>.removeTooltip(" for a description.");
<item:mekanism:electric_pump>.removeTooltip(" for a description.");
<item:mekanism:electrolytic_separator>.removeTooltip(" for a description.");
<item:mekanism:elite_bin>.removeTooltip(" for a description.");
<item:mekanism:elite_chemical_tank>.removeTooltip(" for a description.");
<item:mekanism:elite_combining_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_compressing_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_crushing_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_energy_cube>.removeTooltip(" for a description.");
<item:mekanism:elite_enriching_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_fluid_tank>.removeTooltip(" for a description.");
<item:mekanism:elite_induction_cell>.removeTooltip(" for a description.");
<item:mekanism:elite_induction_provider>.removeTooltip(" for a description.");
<item:mekanism:elite_infusing_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_injecting_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_logistical_transporter>.removeTooltip(" for a description.");
<item:mekanism:elite_mechanical_pipe>.removeTooltip(" for a description.");
<item:mekanism:elite_pressurized_tube>.removeTooltip(" for a description.");
<item:mekanism:elite_purifying_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_sawing_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_smelting_factory>.removeTooltip(" for a description.");
<item:mekanism:elite_thermodynamic_conductor>.removeTooltip(" for a description.");
<item:mekanism:elite_universal_cable>.removeTooltip(" for a description.");
<item:mekanism:energized_smelter>.removeTooltip(" for a description.");
<item:mekanism:enrichment_chamber>.removeTooltip(" for a description.");
<item:mekanism:fluidic_plenisher>.removeTooltip(" for a description.");
<item:mekanism:fluorite_ore>.removeTooltip(" for a description.");
<item:mekanism:formulaic_assemblicator>.removeTooltip(" for a description.");
<item:mekanism:fuelwood_heater>.removeTooltip(" for a description.");
<item:mekanism:induction_casing>.removeTooltip(" for a description.");
<item:mekanism:induction_port>.removeTooltip(" for a description.");
<item:mekanism:industrial_alarm>.removeTooltip(" for a description.");
<item:mekanism:isotopic_centrifuge>.removeTooltip(" for a description.");
<item:mekanism:laser>.removeTooltip(" for a description.");
<item:mekanism:laser_amplifier>.removeTooltip(" for a description.");
<item:mekanism:laser_tractor_beam>.removeTooltip(" for a description.");
<item:mekanism:lead_ore>.removeTooltip(" for a description.");
<item:mekanism:logistical_sorter>.removeTooltip(" for a description.");
<item:mekanism:metallurgic_infuser>.removeTooltip(" for a description.");
<item:mekanism:modification_station>.removeTooltip(" for a description.");
<item:mekanism:module_attack_amplification_unit>.removeTooltip(" for a description");
<item:mekanism:module_attack_amplification_unit>.removeTooltip(" for a description");
<item:mekanism:module_attack_amplification_unit>.removeTooltip(" for a description.");
<item:mekanism:module_charge_distribution_unit>.removeTooltip(" for a description.");
<item:mekanism:module_dosimeter_unit>.removeTooltip(" for a description.");
<item:mekanism:module_electrolytic_breathing_unit>.removeTooltip(" for a description.");
<item:mekanism:module_energy_unit>.removeTooltip(" for a description.");
<item:mekanism:module_excavation_escalation_unit>.removeTooltip(" for a description.");
<item:mekanism:module_farming_unit>.removeTooltip(" for a description.");
<item:mekanism:module_gravitational_modulating_unit>.removeTooltip(" for a description.");
<item:mekanism:module_hydraulic_propulsion_unit>.removeTooltip(" for a description.");
<item:mekanism:module_inhalation_purification_unit>.removeTooltip(" for a description.");
<item:mekanism:module_jetpack_unit>.removeTooltip(" for a description.");
<item:mekanism:module_locomotive_boosting_unit>.removeTooltip(" for a description.");
<item:mekanism:module_magnetic_attraction_unit>.removeTooltip(" for a description.");
<item:mekanism:module_nutritional_injection_unit>.removeTooltip(" for a description.");
<item:mekanism:module_radiation_shielding_unit>.removeTooltip(" for a description.");
<item:mekanism:module_silk_touch_unit>.removeTooltip(" for a description.");
<item:mekanism:module_solar_recharging_unit>.removeTooltip(" for a description.");
<item:mekanism:module_teleportation_unit>.removeTooltip(" for a description.");
<item:mekanism:module_vein_mining_unit>.removeTooltip(" for a description.");
<item:mekanism:module_vision_enhancement_unit>.removeTooltip(" for a description.");
<item:mekanism:nutritional_liquifier>.removeTooltip(" for a description.");
<item:mekanism:oredictionificator>.removeTooltip(" for a description.");
<item:mekanism:osmium_compressor>.removeTooltip(" for a description.");
<item:mekanism:osmium_ore>.removeTooltip(" for a description.");
<item:mekanism:personal_chest>.removeTooltip(" for a description.");
<item:mekanism:precision_sawmill>.removeTooltip(" for a description.");
<item:mekanism:pressure_disperser>.removeTooltip(" for a description.");
<item:mekanism:pressurized_reaction_chamber>.removeTooltip(" for a description.");
<item:mekanism:purification_chamber>.removeTooltip(" for a description.");
<item:mekanism:qio_dashboard>.removeTooltip(" for a description.");
<item:mekanism:qio_drive_array>.removeTooltip(" for a description.");
<item:mekanism:qio_exporter>.removeTooltip(" for a description.");
<item:mekanism:qio_importer>.removeTooltip(" for a description.");
<item:mekanism:qio_redstone_adapter>.removeTooltip(" for a description.");
<item:mekanism:quantum_entangloporter>.removeTooltip(" for a description.");
<item:mekanism:radioactive_waste_barrel>.removeTooltip(" for a description.");
<item:mekanism:resistive_heater>.removeTooltip(" for a description.");
<item:mekanism:restrictive_transporter>.removeTooltip(" for a description.");
<item:mekanism:rotary_condensentrator>.removeTooltip(" for a description.");
<item:mekanism:security_desk>.removeTooltip(" for a description.");
<item:mekanism:seismic_reader>.removeTooltip(" for a description.");
<item:mekanism:seismic_vibrator>.removeTooltip(" for a description.");
<item:mekanism:solar_neutron_activator>.removeTooltip(" for a description.");
<item:mekanism:sps_casing>.removeTooltip(" for a description.");
<item:mekanism:sps_port>.removeTooltip(" for a description.");
<item:mekanism:steel_casing>.removeTooltip(" for a description.");
<item:mekanism:structural_glass>.removeTooltip(" for a description.");
<item:mekanism:supercharged_coil>.removeTooltip(" for a description.");
<item:mekanism:superheating_element>.removeTooltip(" for a description.");
<item:mekanism:teleporter>.removeTooltip(" for a description.");
<item:mekanism:teleporter_frame>.removeTooltip(" for a description.");
<item:mekanism:thermal_evaporation_block>.removeTooltip(" for a description.");
<item:mekanism:thermal_evaporation_controller>.removeTooltip(" for a description.");
<item:mekanism:thermal_evaporation_valve>.removeTooltip(" for a description.");
<item:mekanism:tin_ore>.removeTooltip(" for a description.");
<item:mekanism:ultimate_bin>.removeTooltip(" for a description.");
<item:mekanism:ultimate_chemical_tank>.removeTooltip(" for a description.");
<item:mekanism:ultimate_combining_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_compressing_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_crushing_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_energy_cube>.removeTooltip(" for a description.");
<item:mekanism:ultimate_enriching_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_fluid_tank>.removeTooltip(" for a description.");
<item:mekanism:ultimate_induction_cell>.removeTooltip(" for a description.");
<item:mekanism:ultimate_induction_provider>.removeTooltip(" for a description.");
<item:mekanism:ultimate_infusing_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_injecting_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_logistical_transporter>.removeTooltip(" for a description.");
<item:mekanism:ultimate_mechanical_pipe>.removeTooltip(" for a description.");
<item:mekanism:ultimate_pressurized_tube>.removeTooltip(" for a description.");
<item:mekanism:ultimate_purifying_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_sawing_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_smelting_factory>.removeTooltip(" for a description.");
<item:mekanism:ultimate_thermodynamic_conductor>.removeTooltip(" for a description.");
<item:mekanism:ultimate_universal_cable>.removeTooltip(" for a description.");
<item:mekanism:uranium_ore>.removeTooltip(" for a description.");
